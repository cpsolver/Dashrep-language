...
[-put-into-phrase test-assignment  17 -]
[-put-into-phrase should-be-17  [-test-assignment-] -]
[-put-into-phrase correct-value-for-should-be-17  17 -]
[-put-into-phrase first-word-phrase  copied -]
[-put-into-phrase second-word-phrase  text -]
...
[-put-into-phrase correct-value-for-should-be-copied-text  copied text -]
[-put-into-phrase dashrep-special-replacement-adjacent-space  &nbsp; -]
[-put-into-phrase dashrep-special-replacement-hyphen  &ndash; -]
...
[-put-into-phrase correct-value-for-should-be-one  one -]
[-put-into-phrase should-be-multiple  [-zero-one-multiple 2-] -]
[-put-into-phrase correct-value-for-should-be-multiple  multiple -]
[-put-into-phrase should-be-size-zero  [-get-count-of-words empty-text-] -]
[-put-into-phrase correct-value-for-should-be-size-zero  0 -]
[-put-into-phrase should-be-size-one  [-get-count-of-words should-be-17-] -]
[-put-into-phrase correct-value-for-should-be-size-one  1 -]
[-put-into-phrase list-of-size-three  4 5 6 -]
[-put-into-phrase should-be-size-three  [-get-count-of-words list-of-size-three-] -]
[-put-into-phrase correct-value-for-should-be-size-three  3 -]
[-put-into-phrase list-of-numbers  3 12 7 13 4 -]
...
[-put-into-phrase correct-value-for-should-be-same-words-no  no -]
[-put-into-phrase item-one  waltz -]
[-put-into-phrase item-two  dance -]
[-put-into-phrase should-be-same-yes  [-yes-or-no-same-two-phrase-definitions item-one item-one-] -]
[-put-into-phrase correct-value-for-should-be-same-yes  yes -]
[-put-into-phrase should-be-same-no  [-yes-or-no-same-two-phrase-definitions item-one item-two-] -]
[-put-into-phrase correct-value-for-should-be-same-no  no -]
[-put-into-phrase test-counter  17 -]
[-put-into-phrase test-value  3 -]
[-put-into-phrase compare-numbers-equal  [-numeric-equal-greater-less-compare 16 16-] -]
[-put-into-phrase correct-value-for-compare-numbers-equal  equal -]
[-put-into-phrase compare-numbers-less  [-numeric-equal-greater-less-compare 18 19-] -]
[-put-into-phrase correct-value-for-compare-numbers-less  less -]
[-put-into-phrase compare-numbers-greater  [-numeric-equal-greater-less-compare 21 20-] -]
[-put-into-phrase correct-value-for-compare-numbers-greater  greater -]
[-copy-text empty-text test-text-length-0-]
[-put-into-phrase should-be-length-0  [-get-count-of-characters test-text-length-0-] -]
[-put-into-phrase correct-value-for-should-be-length-0  0 -]
[-put-into-phrase test-text-length-1  a -]
[-put-into-phrase should-be-length-1  [-get-count-of-characters test-text-length-1-] -]
[-put-into-phrase correct-value-for-should-be-length-1  1 -]
[-put-into-phrase test-text-length-7  abcdefg -]
[-put-into-phrase should-be-length-7  [-get-count-of-characters test-text-length-7-] -]
[-put-into-phrase correct-value-for-should-be-length-7  7 -]
[-put-into-phrase should-be-item-with-value-7  [-get-word-at-position list-of-numbers 3-] -]
[-put-into-phrase correct-value-for-should-be-item-with-value-7  7 -]
[-generate-counts-from-integer-to-integer 0 7 counts-from-0-to-7-]
[-put-into-phrase correct-value-for-counts-from-0-to-7  0 1 2 3 4 5 6 7 -]
[-generate-counts-from-integer-to-integer 5 -4 counts-from-5-to-minus-4-]
[-put-into-phrase correct-value-for-counts-from-5-to-minus-4  5 4 3 2 1 0 -1 -2 -3 -4 -]
[-put-into-phrase minimum-maximum-result  [-numeric-minimum 2 8 -] [-numeric-maximum 2 8 -] [-numeric-minimum 3 -] [-numeric-maximum 4 -] -]
[-put-into-phrase correct-value-for-minimum-maximum-result  2 8 3 4 -]
...
[-put-into-phrase correct-value-for-list-of-first-items-in-two-dimensions ??? -]
[-put-into-phrase correct-value-for-list-of-second-items-in-two-dimensions ??? -]
...
[-put-into-phrase word-alpha  alpha  -]
...
[-prepend-text-no-space character-space sample-word-list-one-]
[-append-new-line sample-word-list-one-]
[-append-text-no-space character-space sample-word-list-one-]
[-put-into-phrase correct-value-for-sample-word-list-one  ??? -]
...
[-put-into-phrase text-with-named-html-entities  abc &amp; &apos; &lt; &gt; &ldquo; &rdquo; &quot; def  -]
[-put-into-phrase text-with-tag-and-attribute  <p style="xyz">... and a < span style="whatever" >wet< / span > dolphin ...<br />...</p>  -]
[-copy-and-remove-attributes-from-xml-tags text-with-tag-and-attribute text-with-tag-]
[-put-into-phrase correct-value-for-text-with-tag-and-attribute  ??? -]
[-put-into-phrase list-of-words-to-search-based-on-prefix  here-is-something here-is-something-else hereis-something-else and-something-else -]
[-put-into-phrase text-begins-with  here-is -]
...
[-put-into-phrase correct-value-for-list-of-words-that-begin-with-text  ??? -]
[-put-into-phrase text-contains  is  -]
...
[-put-into-phrase actions-in-compiler-but-not-interpreter  get-cgi-information standard-output trace-show-where -]
...
[-put-into-phrase first-unique-value  [-unique-value-] -]
[-put-into-phrase second-unique-value  [-unique-value-] -]
...
[-put-into-phrase text-being-copied  abc DEF 123 -]
...
[-put-into-phrase text-being-copied  17 9 183 65 -]
...
[-put-into-phrase text-being-codified  <xyz>&amp;</xyz> -]
...
[-value-of-pi-]
[-put-into-phrase dashrep-stop-translation  yes -]
[-value-of-pi-]
--------
...
[-put-into-phrase escape-text  step1 -]
[-escape-if-yes no-]
[-copy-text sample-escape-text escape-text-]
[-escape-if-yes yes-]
[-put-into-phrase escape-text  step3 -]
[-escape-if-yes yes-]
--------
...
[-put-into-phrase list-of-parameter-values-for-list-named-participant-names-full  [-case-info-idlistparticipants-] -]
...
$test_number_count ++;
#  remove-from-cpan-version-begin
$string_return_value = &dashrep_translate::dashrep_get_replacement( "should-be-number-three" );
#  remove-from-cpan-version-end
#  uncomment-for-cpan-version-begin
# $string_return_value = &dashrep_get_replacement( "should-be-number-three" );
#  uncomment-for-cpan-version-end
if ( $string_return_value eq "3" ) { $one_if_ok = 1; } else { $one_if_ok = 0; };
if ( $one_if_ok == 1 ) { $test_OK_counter ++ };
if ( $one_if_ok == 1 ) { $results_text .= $being_tested . "OK\n" } else { $results_text .= $being_tested . "ERROR\n\n" };
...
#  uncomment-for-cpan-version-end
# $results_text .= "[[" . $string_return_value . "]]\n" ;
if ( $string_return_value eq "alpha alpha-here beta delta - beta whatever something-here gamma alpha-here alpha delta and - alpha beta beta alpha beta - alpha alpha-here and beta gamma delta something-here whatever - 2 2 1 3 1 2 1 1 - 1 2 3 4 5 7 8 13" ) { $one_if_ok = 1; } else { $one_if_ok = 0; };
if ( $one_if_ok == 1 ) { $test_OK_counter ++ };
if ( $one_if_ok == 1 ) { $results_text .= $being_tested . "OK\n" } else { $results_text .= $being_tested . "ERROR\n\n" };
