...
[-should-be-length-0 = [-count-of-characters-in-phrase-definition: test-text-length-0-]-]
[-test-text-length-1 = a-]
[-should-be-length-1 = [-count-of-characters-in-phrase-definition: test-text-length-1-]-]
[-test-text-length-7 = abcdefg-]
[-should-be-length-7 = [-count-of-characters-in-phrase-definition: test-text-length-7-]-]
