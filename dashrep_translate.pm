...
#  position-of-word-in-phrase-within-phrase
        ...
        if ( ( $action_name eq "position-of-word-in-phrase" ) || ( $action_name eq "yes-or-no-word-in-phrase" ) || ( $action_name eq "position-of-word-in-phrase-within-phrase" ) )
        {
            if ( $number_of_operands != 2 )
            {
                $text_for_value = $global_dashrep_replacement{ "dashrep-undefined" } ;
