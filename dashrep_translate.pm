...
BEGIN {
    ...
    $global_check_operand_one_is_phrase_name_for_action{ "positions-multiple-of-delimiter-within-phrase-put-into-phrase" } = "yes" ;
    $global_check_operand_two_is_phrase_name_for_action{ "positions-multiple-of-delimiter-within-phrase-put-into-phrase" } = "yes" ;
