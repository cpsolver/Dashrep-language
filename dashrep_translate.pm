...
#  copy-from-phrase-to-phrase-characters-from-position-to-position
        ...
        if ( ( $action_name eq "copy-from-phrase-to-phrase-and-replace-string-in-phrase-with-phrase" ) || ( $action_name eq "copy-from-phrase-to-phrase-characters-from-position-to-position" ) )
        {
            if ( $number_of_operands != 4 )
            {
                $text_for_value = " " ;
            ...
            if ( $action_name eq "copy-from-phrase-to-phrase-characters-from-position-to-position" )
            {
                ...
                $global_dashrep_replacement{ $target_phrase_name } = substr( $source_text , ( $pointer_one - 1 ) , ( $pointer_two - 1 ) ) ;
                if ( $global_dashrep_replacement{ "dashrep-action-trace-on-yes-or-no" } eq "yes" )
                {
