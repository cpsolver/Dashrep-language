...
#  copy-from-phrase-unique-words-to-phrase
#  copy-from-two-phrases-words-found-in-both-to-phrase -- deprecated in favor of better action name

        if ( ( $action_name eq "copy-words-found-in-both-phrases-to-phrase" ) || ( $action_name eq "copy-from-two-phrases-words-found-in-both-to-phrase" ) || ( $action_name eq "copy-from-first-phrase-words-not-found-in-second-phrase-to-phrase" ) || ( $action_name eq "copy-from-phrase-unique-words-to-phrase" ) )
        {
            $action_result = " " ;
