...
BEGIN {
    ...
    $global_required_number_of_operands_for_action{ "copy-from-phrase-to-phrase-words-that-begin-with-text-in-phrase" } = 3 ;
    ...
    $global_required_number_of_operands_for_action{ "dashrep-stop-translation" } = 0 ;
    $global_required_number_of_operands_for_action{ "copy-current-replacement-results-into-phrase" } = 1 ;
    ...
    $global_check_operand_three_phrase_is_not_empty_for_action{ "copy-from-phrase-to-phrase-words-that-begin-with-text-in-phrase" } = "yes" ;
    ...
    $global_check_operand_one_is_phrase_name_for_action{ "copy-from-phrase-to-phrase-words-that-begin-with-text-in-phrase" } = "yes" ;
    $global_check_operand_two_is_phrase_name_for_action{ "copy-from-phrase-to-phrase-words-that-begin-with-text-in-phrase" } = "yes" ;
    ...
    $global_check_operand_one_is_phrase_name_for_action{ "copy-current-replacement-results-into-phrase" } = "yes" ;
...
#-----------------------------------------------
#  Handle the action:
#  copy-from-phrase-to-phrase-words-that-begin-with-text-in-phrase

        if ( $action_name eq "copy-from-phrase-to-phrase-words-that-begin-with-text-in-phrase" )
        {
            $action_result = " " ;
...
#-----------------------------------------------
#  Handle the action:
#  copy-current-replacement-results-into-phrase

        if ( $action_name eq "copy-current-replacement-results-into-phrase" )
        {
            $action_result = " " ;

    $global_trace_log .= "{{trace; action " . $action_name . " has remaining text: " . $replacement_text . "}}\n";

            $global_dashrep_replacement{ $operand_one } = $text_begin . $action_result . $text_end ;
            if ( $global_dashrep_replacement{ "dashrep-action-trace-on-yes-or-no" } eq "yes" )
            {
                $global_trace_log .= "{{trace; action " . $action_name . " saved remaining text in phrase unexpanded-dashrep-replacements-to-resume-after-escape" . "}}\n";
            }
#  end of action code
            $replacement_text = $text_begin . $action_result . $text_end ;
            next ;
