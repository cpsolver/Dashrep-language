...
BEGIN {
    ...
    $global_check_operand_one_phrase_is_not_empty_for_action{ "copy-from-phrase-to-phrase-words-that-begin-with-text-in-phrase" } = "yes" ;
    $global_check_operand_two_phrase_is_not_empty_for_action{ "copy-from-phrase-to-phrase-words-that-begin-with-text-in-phrase" } = "yes" ;
    ...
    $global_check_operand_three_is_phrase_name_for_action{ "copy-from-phrase-to-phrase-words-that-begin-with-text-in-phrase" } = "yes" ;
