...
#  prepend-from-phrase-to-phrase-no-space
        ...
        if ( ( $action_name eq "append-from-phrase-to-phrase" ) || ( $action_name eq "append-from-phrase-to-phrase-no-space" ) || ( $action_name eq "prepend-from-phrase-to-phrase" ) || ( $action_name eq "prepend-from-phrase-to-phrase-no-space" ) )
        {
            if ( $number_of_operands != 2 )
            {
                $text_for_value = " " ;
