...
BEGIN {
    ...
    $global_required_number_of_operands_for_action{ "position-of-string-in-phrase-within-phrase-starting-after-character-position" } = 3 ;
    ...
    $global_check_operand_three_is_positive_integer_for_action{ "position-of-string-in-phrase-within-phrase-starting-after-character-position" } = "yes" ;
    ...
    $global_check_operand_one_is_phrase_name_for_action{ "position-of-string-in-phrase-within-phrase-starting-after-character-position" } = "yes" ;
    $global_check_operand_two_is_phrase_name_for_action{ "position-of-string-in-phrase-within-phrase-starting-after-character-position" } = "yes" ;
...
#  position-of-string-in-phrase-within-phrase-starting-after-character-position

        if ( ( $action_name eq "position-of-string-in-phrase-within-phrase" ) || ( $action_name eq "position-of-string-in-phrase-within-phrase-starting-after-character-position" ) )
        {
            $action_result = " " ;
            ...
            if ( $action_name eq "position-of-string-in-phrase-within-phrase-starting-after-character-position" )
            {
                $search_starting_position = $operand_three + 0 ;
            }
            $action_result = "0" ;
